    <footer class="footer footer-static footer-light">
        <p class="clearfix text-muted text-center px-2"><span>Copyright  &copy; 2019 <a href="https://fredynurapriyanto.com" target="_blank" class="text-bold-800 primary darken-2">FREDY NUR APRIYANTO </a>, All rights reserved. </span></p>
    </footer>
